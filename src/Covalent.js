...
function getXYTransactions(chainId, dexname, address) {
    return callApi(`/${chainId}/xy=k/${dexname}/address/${address}/transactions`);
}
...
export { getAllChains, getSupportedDexes, getSupportedDexesByChain, getDexChartData, 
    getPools, getAllTokens, getTokens, getTokenBalances, getTransactions, getXYTransactions };